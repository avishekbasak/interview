...
### Steps to Use:
1. git clone git@github.com:tabzo/interview.git
2. cd AirportBaggageRoutingSystem;
3. mvn clean install
4. java -jar target/airport-baggage-routing.jar src/test/resources/data/Input.txt